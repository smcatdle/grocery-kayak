...
public class MacePriceEngine extends PriceEngine {

    private final Logger logger = Logger.getLogger(MacePriceEngine.class.getName());
    ...
    public Set findPageLinks(String pageLink, List searchLinks) {
        ...
        if(pageLink.equals(GROCERY_PAGE)) {
        	...
        	logger.log(Level.INFO, "Initial Page Link");
    ...
    public IProduct extractProductElement(ProductElement productElement) {
        ...
        try {
	        ...
	        } else if (price != null && price.toUpperCase().contains("ANY")) {
    ...
    private Set getSubLinks(String pageLink, String xpathPattern) {
        ...
        try {
            ...
            for (HtmlElement element : htmlElements) {
            	...
            	logger.log(Level.INFO, "Sub Link [" + pageLink + "]");

...
public class DealzPriceEngine extends PriceEngine {
    ...
    private final Logger logger = Logger.getLogger(DealzPriceEngine.class.getName());
    
    protected int pageIncrement;
    protected String GROCERY_PAGE = "http://www.dealz.ie/food-and-drink";
    
    public DealzPriceEngine() {
    ...
    public List findProductElements(HtmlPage htmlPage, String pageLink, String id) {
        ...
        try {
        	...
        	htmlPage.executeJavaScript("loadMore();");
            Thread.sleep(2000L);
            htmlPage.executeJavaScript("loadMore();");  
            Thread.sleep(2000L);  
            htmlPage.executeJavaScript("loadMore();");

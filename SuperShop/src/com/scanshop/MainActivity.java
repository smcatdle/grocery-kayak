...
public class MainActivity extends ActionBarActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        // Add three tabs
        //this.onAddTab(super.getCurrentFocus());
    ...
    /*public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.main, menu);
            MenuItem searchItem = menu.findItem(R.id.action_search);
            View mSearchView = null;
            if(VERSION_CODES.HONEYCOMB <= Build.VERSION.SDK_INT){
            mSearchView = new android.widget.SearchView(this);
            }else{
            mSearchView = new SearchView(this);
            }
            MenuItemCompat.setActionView(searchItem, mSearchView);
            //SearchViewCompat.setOnQueryTextListener(mSearchView, mOnQueryTextListener);
            return true;
        }*/
    ...
    private class TabListener implements ActionBar.TabListener {
        ...
        public void onTabSelected(Tab tab, FragmentTransaction ft) {
            ft.add(R.id.content_frame, mFragment, mFragment.getText());
        }

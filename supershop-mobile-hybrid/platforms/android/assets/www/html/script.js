...
.controller('MenuController', ['$scope', 'sessionService', function($scope, sessionService) {
...
angular
		...
		.config([ '$stateProvider', function($stateProvider) {
			$stateProvider.state('store', {
				...
				data : {
					pageTitle : 'SuperShop Ireland (Beta)'
				}
...
angular.module("account/login.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("account/login.tpl.html",
    ...
    "<p align=\"center\" class=\"general-text-title\">You need to Login before adding groceries to your basket...</p>\n" +
    "<table align=\"center\" style=\"margin-top: 70px;\"><tr><td><div>\n" + 
    "  <form ng-submit=\"login()\">\n" +
    "    <div class=\"form-group\">\n" +
    "      <md-input-container>\n" +
    "         <input md-maxlength=\"30\" minlength=\"6\" placeholder=\"Email\" ng-model=\"account.email\" type=\"email\" required>" +
    "      </md-input-container>\n" +
    "      <md-input-container>\n" +
    "        <input md-maxlength=\"12\" minlength=\"6\" type=\"password\" placeholder=\"Password\" ng-model=\"account.password\" ng-required=\"true\">\n" +
    "      </md-input-container></br></br>\n" +
    "      <div style=\"color: red\" ng-show=\"$root.invalidLogin\">\n" +
    "        The username/password is invalid.\n" +
    "      </div>\n" +
    "      <button align=\"center\" class=\"btn btn-success\" type=\"submit\">Login</button>\n" +
    "      <a ui-sref=\"register\">Not registered yet?</a><br>\n" +
    "  </div></form><br>\n" +
    "</div></td></tr></table>\n" +
    "");
}]);
...
angular.module("account/register.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("account/register.tpl.html",
   "<div class=\"row\" style=\"padding-top: 130px;\">\n" +
    "<p align=\"center\" class=\"general-text-title\">Register to start adding groceries to your basket...</p>\n" +
    "<table align=\"center\" style=\"margin-top: 70px;\"><tr><td><div >\n" +
    "  <form ng-submit=\"register()\">\n" +
    "      <div class=\"form-group\">\n" +
    "      <md-input-container >" +
    "        <input ng-model=\"account.email\" md-maxlength=\"30\" minlength=\"6\" type=\"email\" placeholder=\"Email\" ng-required=\"true\">" +
    "       </md-input-container>" +
    "      </div>\n" +
    "      <div class=\"form-group\">\n" +
    "       <md-input-container flex>" +
    "          <input type=\"password\" md-maxlength=\"12\" minlength=\"6\" Placeholder=\"Password\" ng-model=\"account.password\" ng-required=\"true\"/>\n" +
    "       </md-input-container>" +
    "      </div>\n" +
    "      <div class=\"form-group\">\n" +
    "       <md-input-container flex>" +
    "          <input type=\"password\" md-maxlength=\"12\" minlength=\"6\" placeholder=\"Confirm Password\" ng-model=\"account.confirm\" ng-required=\"true\"/>\n" +
    "       </md-input-container>" +
    "      </div>" +
    "      <label style=\"color: red;\" ng-show=\"account.password != account.confirm\">Passwords do not match.</label></br>" + 
    "      <label style=\"color: red;\">By clicking Register you agree to the</label></br>\n" + 
    "      <label style=\"color: red;\">latest terms and conditions.</label>" +
    "      <a ui-sref=\"terms_and_cond\">Terms</a></br>\n" +
    "      <button class=\"btn btn-success\" ng-disabled=\"account.password != account.confirm || account.email == ''\" type=\"submit\">Register</button>\n" +
    "  </form>\n" +
